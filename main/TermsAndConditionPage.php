...
<body>
    ...
    <section id="privacypolicy">
        <div class="container">
                ...
                <p>Welcome to Shinn Kya Mal!</p>
            
                <p>These terms and conditions outline the rules and regulations for the use of Shinn Kya Mal's Website, located at
                    shinnkyamal.com.mm.</p>
            
                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Shinn Kya Mal
                ...
                <p>We employ the use of cookies. By accessing Shinn Kya Mal, you agreed to use cookies in agreement with the Shinn
                    Kya Mal's Privacy Policy.</p>
                ...
                <p>Unless otherwise stated, Shinn Kya Mal and/or its licensors own the intellectual property rights for all material
                    on Shinn Kya Mal. All intellectual property rights are reserved. You may access this from Shinn Kya Mal for your
                    own personal use subjected to restrictions set in these terms and conditions.</p>
            
                <p>You must not:</p>
                <ul>
                    <li>Republish material from Shinn Kya Mal</li>
                    <li>Sell, rent or sub-license material from Shinn Kya Mal</li>
                    <li>Reproduce, duplicate or copy material from Shinn Kya Mal</li>
                    <li>Redistribute content from Shinn Kya Mal</li>
                </ul>
            
                <p>This Agreement shall begin on the date hereof.</p>
            
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
                    areas of the website. Shinn Kya Mal does not filter, edit, publish or review Comments prior to their presence on
                    the website. Comments do not reflect the views and opinions of Shinn Kya Mal,its agents and/or affiliates.
                    Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
                    by applicable laws, Shinn Kya Mal shall not be liable for the Comments or for any liability, damages or expenses
                    caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
                    website.</p>
            
                <p>Shinn Kya Mal reserves the right to monitor all Comments and to remove any Comments which can be considered
                ...
                <p>You hereby grant Shinn Kya Mal a non-exclusive license to use, reproduce, edit and authorize others to use,
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
                    ...
                    records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Shinn Kya
                    Mal; and (d) the link is in the context of general resource information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
                    must inform us by sending an e-mail to Shinn Kya Mal. Please include your name, your organization name, contact
                ...
                <p>No use of Shinn Kya Mal's logo or other artwork will be allowed for linking absent a trademark license agreement.
                </p>
    ...
    <footer class="bg-primary">
        <div class="container">
            <a class="brandlink" href="homePage.php">
                <h3>Shinn Kya Mal</h3>
            </a>
            <div class="row">
                <div class="col-md-6 links">
                    <ul>
                        ...
                        <li><a href="TermsAndConditionPage.php">Terms and Conditions</a></li>
