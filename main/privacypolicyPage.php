...
<body>
    ...
    <section id="privacypolicy">
        <div class="container">
            ...
            <p>Cash ("us", "we", or "our") operates the www.cash.com website (the "Service").</p>

            <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when
                you use our Service and the choices you have associated with that data. Our Privacy Policy for Cash is
            ...
            <p>Cash uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>If you are located outside Myanmar and choose to provide information to us, please note that we transfer
                the data, including Personal Data, to Myanmar and process it there.</p>
            ...
            <p>Cash will take all steps reasonably necessary to ensure that your data is treated securely and in
            ...
            <p>Cash may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Cash</li>
            ...
            <ul>
                <li>By email: cashtracker@info.com</li>
