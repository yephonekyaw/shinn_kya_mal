<?php
    ...
    if(isset($_SESSION['user']))
    {
        ...
        $sqlCatId = "SELECT * FROM incomecat WHERE income_categories_name='$catName' AND extra_cat_on_user_id IN(0,'$user_id') ";
        ...
        mysqli_query($conn, "DELETE FROM incomebycat WHERE income_cat_amount = 0 ");
